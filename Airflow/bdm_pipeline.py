...
def import_main_point():
    try:
        ...
        print(f"ERROR in import_main_point: {e}")
        raise
...
with DAG(
    ...
    accomodation_extra = PythonOperator(
        task_id='import_accomodation_and_extra_info',
        python_callable=import_accomodation_extra_info
    )
    ...
    #     to= 'your@gmail.com',
    #     subject='Airflow Notification: DAG complete!',
    #     html_content="""
    #             <h3>DAG: {{ dag.dag_id }} completed successfully!</h3>
    #             <p>Execution finished at: {{ ts }}</p>
    #             """,
    #     dag=dag
    #     )

    main_point >>  events >> accomodation_extra
