...
def process_accommodation_record(record: dict, schema: dict) -> dict:
    # Crear DF inferido
    accommodation_schema_dict = json.loads(open('/opt/airflow/schemas/accommodation_schema.json').read())
...
if __name__ == '__main__':
    ...
    file_system_client = datalake_client.get_file_system_client('name_container')
    ...
    get_and_sync_weather(file_system_client, spark, start, end, destination_coords, weather_query, '/opt/airflow/schema/weather_schema.json')
    backfill_trusted_zone(file_system_client, 'weather/', '/opt/airflow/schema/weather_schema.json')
